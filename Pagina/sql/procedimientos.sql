...
-----Paciente-------
DELIMITER // CREATE PROCEDURE InsertarPaciente (
...
END // DELIMITER;
-----Historial-------
DELIMITER // CREATE PROCEDURE InsertarHistorial (IN p_idPaciente INT) BEGIN
INSERT INTO Historial (idPaciente)
VALUES (p_idPaciente);
END // DELIMITER;
-----Cita-------
DELIMITER // CREATE PROCEDURE InsertarCita (
...
END // DELIMITER;
-----Tratamiento-------
DELIMITER // CREATE PROCEDURE InsertarTratamiento (
    IN p_idPaciente INT,
...
DELIMITER // CREATE PROCEDURE InsertarAntecedentePatologico (
    IN p_idHistorial INT,
    IN p_Nombre VARCHAR(50),
    IN p_Estado BOOLEAN,
    IN p_Descripcion TEXT
...
DELIMITER // CREATE PROCEDURE InsertarAntecedenteNoPatologico (
    IN p_idHistorial INT,
    IN p_Nombre VARCHAR(50),
    IN p_Estado BOOLEAN,
    IN p_Descripcion TEXT
...
END // DELIMITER;
-----Factura-------
DELIMITER // CREATE PROCEDURE InsertarFactura (
    IN p_idPaciente INT,
...
END // DELIMITER;
-----Recordatorio-------
DELIMITER // CREATE PROCEDURE InsertarRecordatorio (
    IN p_idPaciente INT,
